	...
	<script>
		//Nuestro codigo de test
			QUnit.test( "calcularPrecio (edad,dia)", function( assert ) {
		 		 ...
		 		 assert.ok( calcularPrecio('lunes', 34) == 2, "lunes < 35 años = 2 € " );
		 		 assert.ok( calcularPrecio('lunes', 35) == 2, "lunes =< 35 años = 2 € " );
		 		 assert.ok( calcularPrecio('lunes', 36) == 5, "lunes < 35 años = 5 € " );
				});
